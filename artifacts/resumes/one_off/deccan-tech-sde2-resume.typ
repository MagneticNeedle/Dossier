...
#regular-entry(
  ...
  main-column-second-row: [
    ...
    - Built a #strong[FastAPI AI Gateway] fronting #strong[5 backend AI microservices] with service-to-service token auth and retry\/backoff baked into both FastAPI middleware and the #strong[HTTPX] transport — #strong[zero dropped jobs] across 50k+ clips and 300+ streams monthly.
...
#strong[Infrastructure:] AWS (SNS, ECS), GCP (BigQuery, VertexAI), Terraform, Docker, Kubernetes, OpenTelemetry, Grafana, Envoy, Cloudflare, GitHub Actions
